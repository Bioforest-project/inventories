...
```{r stem-abundance-visual}

# Stem abundance by plot and census year

stem_abundance <- data_cor %>%
  group_by(Plot, Year) %>%
  summarise(stem_count = n(), .groups = "drop")

ggplot(stem_abundance, aes(x = Year, y = stem_count, color = as.factor(Plot))) +
  geom_line() +
  geom_point() +
  labs(title = "Stem Abundance by Plot and Census Year",
       x = "Census Year",
       y = "Number of Stems",
       fill = "Plot") +
  theme_minimal()
...
ggplot(dbh_stats, aes(x = Year, y = mean_dbh, color = as.factor(Plot))) +
  geom_line() +
  geom_point() +
  labs(title = "Mean DBH by Plot and Census Year",
       x = "Census Year",
       y = "Mean DBH (cm)",
       color = "Plot") +
  theme_minimal()
...
ggplot(species_count, aes(x = Year, y = num_species, colour = as.factor(Plot))) +
  geom_line() +
  geom_point() +
...
# Maps per plot and per census
ggplot(data_cor, aes(x = longitude, y = latitude, color = as.factor(Plot))) +
