...
single_site <- TRUE
if (single_site) {
  data_raw <- read.csv("data/raw_data/harmonized_data_paracou_t2_v1.csv")
...
## Unique stem identifier across sites and plots
...
```{r remove-dead}
data_cor <- data_cor |>
  subset(!(Site == "Misiones" & LifeStatusOriginal == 1)) # to be checked
```
