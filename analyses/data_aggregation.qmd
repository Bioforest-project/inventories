...
#| warning: false
data_species <-
  read_tsv("data/derived_data/taxonomy_v5.tsv") |>
...
data_aggr <- data_cor |>
  ...
  inner_join(read.delim("data/derived_data/traits_v5.tsv"),
...
data_aggr <- data_cor |>
  ...
  inner_join(
    read.delim("data/derived_data/traits_v5.tsv"),
    by = "scientific_cleaned"
  ) |>
  filter(!is.na(genus_trait_value_imputed)) |>
  group_by(Site, Plot,
...
matrix_trait <- read.delim("data/derived_data/traits_v5.tsv") |>
...
#| warning: false
# add wood density
data_cor <- read.delim("data/derived_data/traits_v5.tsv") |>
  subset(trait == "WD") |>
