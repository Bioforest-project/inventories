...
data_species <-
  read.delim("data/derived_data/taxonomy_v3.tsv") |>
...
data_aggr <- data_cor |>
  ...
  merge(
    read.delim("data/derived_data/traits_v3.tsv"),
...
matrix_trait <- read.delim("data/derived_data/traits_v3.tsv") |>
...
```{r add-wd}
# add wood density
data_cor <- read.delim("data/derived_data/traits_v3.tsv") |>
  subset(trait == "WD") |>
  pivot_wider(
    id_cols = "scientific_cleaned",
    names_from = trait,
