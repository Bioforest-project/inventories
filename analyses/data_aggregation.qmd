...
read_harmonized <- function(file){
  ...
  mutate(tax_id = as.numeric(as.factor(paste(ScientificName,
                                             VernName,
                                             Family,
                                             Genus,
                                             Species))))
...
# add clean species information
data_species <-
  read.delim("data/derived_data/taxonomy_v3.1.tsv") |>
  select(contains("cleaned") | contains("tax_id")) |>
  unique()
