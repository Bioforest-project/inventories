...
The following table shows the number of censuses per plots, the first and last year of census, and the number of individuals measured in each census. If you feel like the information is not accurate, please let us know.
...
This step checks for any anomalies in the data, that needs to be removed fro mthe dataset, or modified.
...
if (all(data_nstem$nstem == 1)) {
  text <- paste(
    "In this dataset, the number of stem identifiers and the number of tree identifiers are",
...
### Asymptotic height
A proxy for maximum potential plant height.
...
var_names <- c(
  ...
  "SLA_cwm_ba" = "Specific leaf area \n (mm2 mg-1)",
  "WD_cwm_ba" = "Stem specific wood \n density (g cm-3)",
  "hmax_cwm_ba" = "Asymptotic height \n (m)"
)
