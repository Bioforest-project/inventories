...
if (anyNA(data_cor$scientific_cleaned)) {
  ...
  text <- paste("In this dataset, there are",
    ...
    are distributed across the plots and censuses as shown in the figure below",
    sep = " "
  )
} else {
...
Here we have a figure showing the resolution of taxonomic identification in the data provided. The green part in the bars represents the proportion of trees identified to the species level, in blue upto the genus level, and in red, it shows the proportion of unidentified species.
