...
neutral_div_sp <- species_count %>%
  ...
  summarise(
    ...
    diversity_q0_sp = Diversity(count, q = 0),
    diversity_q1_sp = Diversity(count, q = 1),
    diversity_q2_sp = Diversity(count, q = 2),
    evenness_sp = Shannon(count) / log(n_distinct(scientific)),
...
neutral_div_gen <- data_cor %>%
  ...
  summarise(
    ...
    diversity_q0_gen = Diversity(count, q = 0),
    diversity_q1_gen = Diversity(count, q = 1),
    diversity_q2_gen = Diversity(count, q = 2),
    evenness_gen = Shannon(count) / log(n_distinct(genus)),
