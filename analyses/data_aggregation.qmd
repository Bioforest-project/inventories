...
We paste the name of the plot, the subplot and the tag/ID of the tree to create a new unique identifier for each tree. 

```{r}
data_raw$IdTree <- paste(data_raw$Plot, data_raw$Subplot, data_raw$IdTree)
```
